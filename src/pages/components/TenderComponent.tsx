...
import { Panel, FlexRow, FlexCell, Text, Button, Badge, ProgressBar } from '@epam/promo';
    ...
    return (
        <Panel shadow margin="24">
            <FlexRow alignItems="center">
                <FlexCell grow={1}>
                    <Text size="36" font="sans">{tender.shortDescription}</Text>
                    <Text size="24" font="sans">{tender.fullDescription}</Text>
                    <Text size="18" font="sans">Posted by: {tender.opened_by_org}</Text>
                </FlexCell>
                <FlexCell width="auto">
            ...
            <FlexRow>
                ...
                {tender.status === 'investing' && (
                    <ProgressBar progress={tender.budgetGathered / tender.budgetTotal * 100} />
                )}
